...
AHA_ein_list_errors1a <- vector("list", length(pdfs))
...
for (i in seq_along(pdfs)){
  ...
  AHA_ein_list_errors1a[[i]] <- c(ein, year, text_data)
  saveRDS(AHA_ein_list_errors1a, paste0(created_data_path, "AHA_ein_list_errors1a.rds"))
  }, error=function(e){cat("ERROR :",conditionMessage(e), "\n")})
}
