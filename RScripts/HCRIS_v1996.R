...
for (i in 2008:2011) {
  HCRIS.alpha=read_csv(paste0(created_data_path, "raw data/HCRIS_v1996/HOSPFY",i,"/HOSP_",i,"_ALPHA.csv"),
                       col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.numeric=read_csv(paste0(created_data_path, "raw data/HCRIS_v1996/HOSPFY",i,"/HOSP_",i,"_NMRC.csv"),
                         col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.report=read_csv(paste0(created_data_path, "raw data/HCRIS_v1996/HOSPFY",i,"/HOSP_",i,"_RPT.csv"),
...
write_csv(final.hcris.v1996,paste0(created_data_path, 'raw data/final_HCRIS_v1996.csv'),append=FALSE,col_names=TRUE)
