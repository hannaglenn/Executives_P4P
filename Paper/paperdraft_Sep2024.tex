...
\begin{document}
 ...
 \vspace{3mm}
    ...
    \begin{abstract}
		{\small
         Managers are often seen as drivers of firm decisions, strategies, and performance. In addition, characteristics of managers have been related to employee wages, mergers and acquisition decisions, and financial performance. Health care policies in the US often focus on improving quality of care without increasing costs, but it is unclear how different types of leaders might interact with this goal. In this paper, I estimate the differential response to these quality incentives by different types of nonprofit hospital executives: those with and without a clinical training background. Using a synthetic difference-in-differences methodology, I show that nonclinical executive teams internalize financial incentives on quality more than clinical executive teams. Further, nonclinical executive teams respond to the incentives more similarly to for-profit hospitals, indicating that this may be due to differing preferences for profit versus patient welfare. 
		} 
	\end{abstract}
