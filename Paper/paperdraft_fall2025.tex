...
\begin{document}
 ...
 \vspace{3mm}
    ...
    In panel \ref{fig:mort_synth_clinical}, I show the estimated difference in mortality for always clinical and never clinical leadership teams after 2012. While the magnitude of the difference is similar to that for readmission rates (relative to the mean), mortality is a noisy measure, and I cannot rule out null effects. 
    ...
    \subsection{Clinical CEO}
        ...
        Additionally, I consider the same comparison of clinical and non-clinical leaders, but only for CEOs. That is, do the results hold when considering only the most top manager instead of the executive team as a whole? I compare hospitals with a CEO trained as a doctor to hospitals without a CEO trained as a doctor using the same synthetic difference-in-differences strategy. I present the average treatment effect and standard errors of this estimation in Table . There is no difference in response when only considering clinical CEOs as the treatment since the effects are statistically insignificant or smaller in magnitude. This highlights the importance of considering executive teams as a whole as opposed to just upper managers. 

    \begin{figure}[ht!]
     \caption{Effect of CEO Clinical Training on Readmission and Mortality Rates}
     \centering
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{Readmission Rate}
         \includegraphics[width=\textwidth]{Objects/ceo_read_md_nomd_synth_graph.pdf}
         \label{fig:ceo_read_synth_clinical}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{Mortality Rate}
         \includegraphics[width=\textwidth]{Objects/ceo_mort_md_nomd_synth_graph.pdf}
         \label{fig:ceo_mort_synth_clinical}
     \end{subfigure}
        \label{fig:ceo_clinicalsynthdid}
    \end{figure}
