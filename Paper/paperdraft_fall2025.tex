...
\begin{document}
 ...
 \vspace{3mm}
    ...
    The first prediction of the model is that, all else held equal, hospitals that value profit will have a lower quality than those who value patient welfare in a fee-for-service setting. Second, a hospital's change in quality once pay-for-performance is enacted depends on how much weight the hospital places on profit vs. patient welfare. Particularly, hospitals with higher weight on profit respond more than hospitals with higher weight on patient welfare. Therefore, factors that affect weight $\alpha$ will be correlated with choice of quality, and with how quality changes under new pay-for-performance incentives. In this paper, I test the hypothesis that clinical experience on a hospital's leadership team is a factor that is correlated with weight $\alpha$. 
